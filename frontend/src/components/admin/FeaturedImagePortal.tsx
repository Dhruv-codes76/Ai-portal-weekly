...
interface FeaturedImagePortalProps {
    imageUrl: string;
    imageAlt: string;
    onChange: (data: { featuredImage?: string; featuredImageAlt?: string }) => void;
}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-4">
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold tracking-widest uppercase block text-muted-foreground">Featured Image URL</label>
                        <input
                            type="text"
                            placeholder="https://..."
                            value={imageUrl}
